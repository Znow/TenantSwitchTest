...
namespace TenantSwitchTest.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update TenantSwitchTestDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update TenantSwitchTestEfCoreEntityExtensionMappings to extend the IdentityUser entity
